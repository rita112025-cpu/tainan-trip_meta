...
const TRIP = {
  ...
  transport: [
    {
      ...
      note: '訂位代號 請查高鐵App；成人票 ×2，總價 NT$1,750'
    },
    {
      ...
      note: '訂位代號 請查高鐵App；成人票 ×2，總價 NT$2,020'
    }
  ],

  /* ---------- 3. 住宿（Agoda 訂房確認信，訂單編號 請查Agoda App） ---------- */
  stays: [
    {
  ...
  days: [
    {
      ...
      stops: [
        { time: '14:11', name: '高鐵台南站', en: 'THSR Tainan', lat: 22.9246367, lng: 120.28566,
          ...
          addr: '台南市歸仁區歸仁大道100號',
          note: '訂位代號 請查對應App；轉台鐵沙崙線約 25 分鐘進市區', tag: '交通' },
        { time: '15:00', name: '飯店 Check-in：劇院酒店-台南成功館', en: 'Hotel Check-in', lat: 22.9989, lng: 120.2117,
          addr: '台南市北區成功路46號',
          note: '⚠️ 座標為推估，請出發前核對；訂單編號 請查Agoda App', tag: '住宿' },
    ...
    },
    {
      ...
      stops: [
        ...
        { time: '14:30', name: '八筒甜室', en: '8ottle8ottle Cakelab', lat: 22.9958, lng: 120.2020,
          ...
          note: '⚠️ 已購 Klook 兌換券 ×2（生乳酪罐罐蛋糕+精選茗茶），憑證號 請查Klook App，兌換日期 2026/8/27（週四）；座標為推估請核對；營業 11:00–18:00（週四），最後點餐打烊前1小時即17:00；週二三公休，出發前建議查 IG @8ottle_sweets_ 確認無臨時公休', tag: '吃' },
    ...
    },
    {
      ...
      stops: [
        ...
        { time: '11:30', name: '周氏蝦捲（安平總店）', en: "Chow's Shrimp Rolls", lat: 22.9981946, lng: 120.1746147,
          ...
          note: '⚠️ 已購 Klook 兌換券 ×2（炸蝦捲+魚鬆肉燥飯+綜合湯+杏仁豆腐），憑證號 請查Klook App，兌換日期 2026/8/28（週五）；電話 06-2801304；營業 10:00–21:30，全年無休；注意勿跑到安平路125號「老店」（另一家分店，時間不同）；週五晚間人潮多，11:30 用餐算離峰時段', tag: '吃' },
    ...
    },
    {
      ...
      stops: [
        ...
        { time: '15:00', name: '高鐵台南站', en: 'THSR Tainan', lat: 22.9246367, lng: 120.28566,
          placeId: 'ChIJfXKoA6ZzbjQRrgQ9yogpRsI',
          addr: '台南市歸仁區歸仁大道100號',
          note: '訂位代號 請查對應App；16:13 發車，預留 1 小時緩衝', tag: '交通' }
      ]
    }
  ],
  ...
  checklist: [
    { group: '證件與票券', items: ['身分證', '高鐵訂位代號 請查高鐵App', 'Agoda 訂房確認信（訂單請查Agoda App）', 'Klook 兌換券 QR Code（八筒甜室、周氏蝦捲）', '信用卡 / 現金'] },
